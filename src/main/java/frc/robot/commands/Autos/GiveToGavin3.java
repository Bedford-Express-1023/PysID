...
/** Add your docs here. */
public class GiveToGavin3 extends PPSwerveControllerCommand {
    public SwerveDriveSubsystem drivetrain;
    public static final PathPlannerTrajectory trajectory = PathPlanner.loadPath("Secret3", 3, 4);

    private GiveToGavin3(PathPlannerTrajectory trajectory, Supplier<Pose2d> pose, SwerveDriveKinematics kinematics,
    ...
    public GiveToGavin3(SwerveDriveSubsystem drivetrain) {
        super(
            trajectory, 
