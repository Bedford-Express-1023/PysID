...
public class DriveBackFromTarmac extends CommandBase {
  ...
  private final Trajectory driveTrajectory = TrajectoryGenerator.generateTrajectory(new Pose2d(0, 0, new Rotation2d(0)), List.of(/*new Translation2d(-1+0.53, 0.53)*/), new Pose2d(2.5, 0, new Rotation2d(Math.PI/2)), new TrajectoryConfig(7, 3));
