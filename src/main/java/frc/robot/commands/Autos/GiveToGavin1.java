...
/** Add your docs here. */
public class GiveToGavin1 extends PPSwerveControllerCommand {
    public SwerveDriveSubsystem drivetrain;
    public static final PathPlannerTrajectory trajectory = PathPlanner.loadPath("Secret1", 3, 4);

    private GiveToGavin1(PathPlannerTrajectory trajectory, Supplier<Pose2d> pose, SwerveDriveKinematics kinematics,
    ...
    public GiveToGavin1(SwerveDriveSubsystem drivetrain) {
        super(
            trajectory, 
