...
public class ShootOnce extends SequentialCommandGroup {
  ...
  public ShootOnce(IndexerSubsystem indexerSubsystem, ShooterSubsystem shooterSubsystem, HoodSubsystem hoodSubsystem) {
    m_indexer = indexerSubsystem;
    m_shooter = shooterSubsystem;
    m_hood = hoodSubsystem;
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new ShootAtVelocity(m_indexer, m_shooter, m_hood).withTimeout(2.0), 
